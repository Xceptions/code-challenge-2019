...
#' From the plots above, we can see that our predictions graph look much
#' like our targets in terms of shape. This should be a visual indication
#' that our predictions have a bit of accuracy to them.

#' To the check the error in our predictions, we choose the mean squared error.
